...
| **Extensions page** | The Installed/Browse redesign was **reverted** at the owner's request. It keeps the tabbed layout with explainer cards, now with four tabs: **Connectors · MCP servers · Plugins · Skills** (Plugins added) |
