...
- [ ] **MEM-07** · M7 · `sensitive` and above never leave the device unless the privacy mode and the per-memory flag both allow it; guest sessions read and write no memory (§2)
