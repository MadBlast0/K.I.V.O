...
fn render() -> String {
    ...
    let declarations = [
        ...
        kivo_ipc::protocol::UpdateView::decl(&cfg),
        kivo_ipc::protocol::UpdateState::decl(&cfg),
        kivo_ipc::protocol::WhatsNew::decl(&cfg),
        kivo_core::config::UpdateChannel::decl(&cfg),
        kivo_core::config::UpdateInstall::decl(&cfg),
    ...
    let methods = [
        ...
        ("activityExport", method::ACTIVITY_EXPORT),
        ...
        ("updatesStatus", method::UPDATES_STATUS),
        ("updatesCheck", method::UPDATES_CHECK),
        ("updatesInstall", method::UPDATES_INSTALL),
        ("updatesSeen", method::UPDATES_SEEN),
        ("aboutNotices", method::ABOUT_NOTICES),
